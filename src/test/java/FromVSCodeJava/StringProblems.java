...
//        m6("ab@cd#fg");
	...
	/*
	 * Input = "This is a string"; output= "sihT si a gnirts";
	 */
	...
	// Reverse String without special character i.e place of the special char is as
	// it is after reversing the string
...
//            String str = "I Am Not String";
	 ...
	 * 
	 * String str = "I am Sharan 3595"; System.out.println("input String--->"+str);
	 * String[] starr =str.split(" "); String reverseWord=""; String
	 * reverseWord1="";
	 * 
	 * //output- I ma narahS 3953 for(String s: starr){ StringBuilder sb = new
	 * StringBuilder(s); sb.reverse(); reverseWord += sb.toString(); }
	 * Sysout(reverseWord);
	 * 
	 * //output- 3593 Sharan am I for(int i=starr.length()-1; i>=0; i--){
	 * StringBuilder sb = new StringBuilder(starr[i]); sb.reverse(); reverseWord1 +=
	 * sb.toString(); } Sysout(reverseWord1);
	 * 
	 */
}
